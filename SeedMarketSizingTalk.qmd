...
<details> 
<summary>Regression, rolling averages</summary>
...
Benefits  
  ...
  - Ameliorating lost revenue from land degradation  
...
::: {.incremental}
- Spatial products on probability of fire under current regime (exist!)
- forecasting central tendency of fire sizes    
...
::: {.column width='35%'}
::: {.vcenter}
![Model selected for forecasting](images/ForecastModelSelection.gif){width=400}
:::
:::
...
::: {.column width='65%'}
::: {.vcenter}
![Forecasts](images/fcasts.gif){width=550}
:::
:::
::::
...
::: {.vcenter}
![Preliminary Burn Return Intervals](images/FireReturnInterval.gif){width=600}
:::
...
::: {.vcenter}
![Markov Chains](images/MarkovChains.gif){width=600}
:::
...
- Operate across multiple Operating Systems (OS)  
